...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,400;1,600&amp;display=swap&_v=20240129141456" rel="stylesheet">


    <!-- CSS  -->
    
    <!-- BOOTSTRAP CSS  -->
    <link href="assets/files/libs/bootstrap/bootstrap.min.css?_v=20240129141456" rel="stylesheet"
        integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">

    <!-- CUSTOM STYLES -->
    <link rel="stylesheet" href="assets/css/style.min.css?_v=20240129141456">
...
<body class="light">
    ...
    <!-- BOOTSTRAP JS  -->
    <script src="assets/files/libs/bootstrap/bootstrap.min.js?_v=20240129141456"></script>

    <!-- GSAP JS  -->
    <script src="assets/files/libs/gsap/gsap.min.js?_v=20240129141456"></script>
    <script src="assets/files/libs/gsap/Observer.min.js?_v=20240129141456"></script>

    <!-- CUSTOM SCRIPTS -->
    <script defer src="./assets/js/app.min.js?_v=20240129141456"></script>
</body>
