...
// DRAG AND DROP CALLS IN QUEUE
const dragCallsInQueue = () => {

    gsap.registerPlugin(Observer);
    let root = document.documentElement
    let item = document.getElementById('callsInQueueModal');
    let storageKey = 'callsInQueueElementPositionAndSize';
