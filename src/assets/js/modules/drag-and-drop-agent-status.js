...
// DRAG AND DROP AGENT STATUS
const dragAgentStatus = () => {

    gsap.registerPlugin(Observer);
    let root = document.documentElement
    let item = document.getElementById('agentStatusModal');
    let storageKey = 'agentStatusElementPositionAndSize';
